...
class WeatherDataFetcher:
    ...
    def __init__(self, api_key: str = None):
        ...
        load_dotenv()
        self.api_key = os.getenv("VISUAL_CROSSING_API_KEY", api_key)
        if not self.api_key:
            raise ValueError("VISUAL_CROSSING_API_KEY not found in environment variables or provided.")
